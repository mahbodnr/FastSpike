...
class Network(torch.nn.Module):
    ...
    def forward(
        ...
        if input_voltages is not None:
            input_voltages.masked_fill_(self.refractory > 0, 0.)
        ...
        self.voltage.masked_fill_(self.refractory > 0, self.neurons.v_rest) # reset the voltage of the neurons in the refractory period 
        self.voltage.masked_fill_(self.spikes, self.neurons.v_reset) # change the voltage of spiked neurons to v_reset 
